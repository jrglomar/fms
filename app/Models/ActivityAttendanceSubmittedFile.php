...
class ActivityAttendanceSubmittedFile extends Model
{
    // -----  [[DEFAULT]]  -----  //
        ...
        // [Declare relationships here]
            public function aa_faculty_lists(){
                return $this->belongsTo(ActivityAttendanceRequiredFacultyList::class)->withDefault();
            }
        ...
        protected $with = ['aa_faculty_lists','created_by_user','updated_by_user'];
