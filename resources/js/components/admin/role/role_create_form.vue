            ...
            <div class="col-md-12 collapse" id="create_card">
                <div class="card card-primary">
                    <div class="card-header">
                        <h4 class="text-dark"> <span id="create_card_title">Create</span> Role</h4>
                    </div>
                    <form id="create_form" @submit.prevent="addRole()">
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label class="required-input">Title</label>
                                    <input type="text" class="form-control" id="role_title"
                                    v-model="role_title" placeholder="Title" tabindex="1" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-12">
...
<script>
    export default {
        ...
        mounted() {
            console.log('Role Create Form mounted.')
            this.dataTable();
        },
        ...
        methods:{
            dataTable(){
                this.activityTable = $('#role_table').DataTable({
                "ajax": {url: "http://127.0.0.1:8000/api/v1/role/",
                        dataSrc: ''},
                "columns": [
                    {data: "id"},
                    {data: "title"},
            ...
            refresh(){
                var url = "http://127.0.0.1:8000/api/v1/role/";
            ...
            addRole(){
                var self=this
                axios.post('http://127.0.0.1:8000/api/v1/role',
                {
