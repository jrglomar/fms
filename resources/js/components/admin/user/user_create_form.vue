                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    v-model="email" placeholder="Email" tabindex="1" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    v-model="password"   placeholder="Password" tabindex="1" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    v-model="password_confirmation"   placeholder="Password Confirmation" tabindex="1" required>
                                </div>
                            </div>
                        </div>
                    ...
                    {data: "deleted_at", render: function(data, type, row){
                            if (data == null){
                                ...
                                '<div class="dropdown-menu dropdown-menu-right">' +
                                    '<button class="dropdown-item d-flex btn_view" id="'+ row.id +'" role="button">' +
                                    '<div style="width: 2rem"><i class="fas fa-eye"></i></div>' +
                                    '<div>View Category</div></button>' +
