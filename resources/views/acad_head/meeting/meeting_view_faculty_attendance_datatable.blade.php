            ...
            <div class="card card-primary">
                <div class="card-header">
                    ...
                    <div class="card-header-action">
                        <button type="button" id="btnEditRequiredFaculty" class="btn btn-primary btn-sm" style="font-size: 18px">Edit Required Faculty List <i class="fa fa-edit" aria-hidden="true"></i></button>
                    </div>
                </div>
                <div class="card-body">
