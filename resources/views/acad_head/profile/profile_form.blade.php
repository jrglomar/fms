                ...
                style="background-color: white">
                    <div class="hero-inner">
                        <div class="d-flex justify-content-between">
                            <h6 class="text-dark"> <span id="create_card_title">Faculty </span>Program(s)</h6>
                            <div class="card-header-action">
                                <!-- <button id="createFacultyProgram" type="button" class="btn btn-warning btn-sm" style="font-size: 14px">
                                    Add Faculty Program <i class="fa fa-edit" aria-hidden="true"></i></button> -->
                            </div>
                        </div>
                    ...
                    &nbsp;
                    <div class="hero-inner">
                        <ul id="FacultyProgramList" class="list-group overflow-auto">
                            <li class="list-group-item d-flex justify-content-between" disabled>
                                <span class="text-primary"><strong>Program(s) of Faculty</strong></span>
                            </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="faculty_type_id" name="faculty_type_id" class="form-control" disabled>
                                        <option disabled selected>List of Faculty Type/s</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="academic_rank_id" name="academic_rank_id" class="form-control" disabled>
                                        <option disabled selected>List of Academic Rank/s</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="designation_id" name="designation_id" class="form-control" disabled>
                                        <option disabled selected>List of Designation/s</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="required-input" >Specialization</label>
                                    <select id="specialization_id" name="specialization_id" class="form-control" disabled>
