...
<head>
    ...
    <title>Admin Academic Rank &mdash; PUPQCSS</title>
            ...
            <div class="main-content">
                <section class="section">
                    ...
                    <div class="section-body">
                        ...
                        {{-- Academic Rank Creation Form Component--}}
                        <academic-rank-create-form></academic-rank-create-form>
                        
                        {{-- Academic Rank Table --}}
                        <academic-rank-datatable></academic-rank-datatable>

                        {{-- Academic Rank Update Modal --}}
                        <academic-rank-update-modal></academic-rank-update-modal>
