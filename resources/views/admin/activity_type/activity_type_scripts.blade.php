...
<script>
    $(document).ready(function(){
        ...
        function dataTable(){
                ...
                "ajax": {
                    url: "http://127.0.0.1:8000/api/v1/activity_type/", 
                    dataSrc: ''
                },
                "columns": [
                    { data: "id"},
        ...
        function refresh(){
            let url = APP_URL+'/api/v1/activity_type/'
        ...
        $('#createForm').on('submit', function(e){
            ...
            var form_url = APP_URL+'/api/v1/activity_type/'
        ...
        $(document).on("click", ".btnView", function(){
            var id = this.id;
            let form_url =APP_URL+'/api/v1/activity_type/'+id
        ...
        $('#updateForm').on('submit', function(e){
            e.preventDefault()
            var id = $('#id_edit').val();
            var form_url = APP_URL+'/api/v1/activity_type/'+id
