...
<script>
    $(document).ready(function(){
        ...
        function dataTable(){
                ...
                "ajax": {
                    url: "http://127.0.0.1:8000/api/v1/designation/", 
                    dataSrc: ''
                },
                "columns": [
                    { data: "id"},
                                ...
                                if (data == null){
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <div class="dropdown-item d-flex btnEdit" id="${row.id}" role="button">
                                            ...
                                            <div style="color: red">Delete Designation</div></div></div></div>`;
                                }
                                else{
        ...
        function refresh(){
            let url = APP_URL+'/api/v1/designation/'
        ...
        $(document).on("click", ".btnView", function(){
            var id = this.id;
            let form_url =APP_URL+'/api/v1/designation/'+id
        ...
        $('#updateForm').on('submit', function(e){
            e.preventDefault()
            var id = $('#id_edit').val();
            var form_url = APP_URL+'/api/v1/designation/'+id
        ...
        $('#deactivateForm').on('submit', function(e){
            ...
            var form_url = APP_URL+'/api/v1/designation/destroy/'+id
