...
<head>
    ...
    <title>Admin Faculty Type &mdash; PUPQCSS</title>
            ...
            <div class="main-content">
                <section class="section">
                    ...
                    <div class="section-body">
                        ...
                        {{-- Faculty Type Creation Form Component--}}
                        <faculty-type-create-form></faculty-type-create-form>
                        
                        {{-- Faculty Type Table --}}
                        <faculty-type-datatable></faculty-type-datatable>
