...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb" style="background-color: #FFFFFF; padding-left: 0px; margin-bottom: 0px">
        ...
        <li class="breadcrumb-item" id="admin_user_profile">
        <a href="javascript:window.location.reload();">User Profile</a>
            <script>
                if(window.location.pathname == '/admin/user')
                {
                    document.getElementById("admin_user_profile").classList.add('active');
                    document.getElementById("admin_user_profile").setAttribute("aria-current", "page")
                }
            </script>
        </li>
    </ol>
