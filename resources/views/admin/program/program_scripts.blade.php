...
<script>
    $(document).ready(function(){
        ...
        var BASE_API = APP_URL + '/api/v1/program/'
        ...
        $('#deactivateForm').on('submit', function(e){
            ...
            var form_url = APP_URL+'/api/v1/program/destroy/'+id
