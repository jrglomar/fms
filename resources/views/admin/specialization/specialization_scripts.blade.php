...
<script>
    $(document).ready(function(){
        ...
        var BASE_API = APP_URL + '/api/v1/specialization/'
        ...
        $('#createForm').on('submit', function(e){
            ...
            $.ajax({
                ...
                success: function(data){
                    console.log(data)
                    notification("success", "Specialization");
        ...
        $('#updateForm').on('submit', function(e){
            ...
            $.ajax({
                ...
                success: function(data){
                    notification("info", "Specialization");
                    refresh()
        ...
        $('#deactivateForm').on('submit', function(e){
            ...
            var form_url = APP_URL+'/api/v1/specialization/destroy/'+id
            ...
            $.ajax({
                ...
                success: function(data){
                    notification("error", "Specialization")
                    refresh()
