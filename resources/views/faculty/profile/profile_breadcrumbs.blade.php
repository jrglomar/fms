...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb" style="background-color: #FFFFFF; padding-left: 0px; margin-bottom: 0px">
        ...
        <li class="breadcrumb-item" id="faculty_user">
        <a href="/faculty/user">User</a>
            <script>
                if(window.location.pathname == '/faculty/user')
                {
                    document.getElementById("faculty_user").classList.add('active');
                    document.getElementById("faculty_user").setAttribute("aria-current", "page")
                }
            </script>
        </li>
