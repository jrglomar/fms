        ...
        <div class="col-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h4 class="text-dark">Required Documents</h4>
                    <div class="card-header-action">
                        <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#create_card"
                        aria-expanded="false" aria-controls="create_card">Add Required Document <i
                    ...
                    <table class="table table-sm" id="dataTable" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th>Document/s to be submitted</th>
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tbody>
...
<div hidden>
    <div class="row">
        <div class="col-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h4 class="text-dark">Required Faculty</h4>
                    <div class="card-header-action">
                        <!-- <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#create_card"
